...
export default function TransactionDetailModal({ transaction, creditCards, onClose }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
            ...
            {/* Modal Content */}
            <div className="relative w-full max-w-md bg-white rounded-t-[32px] sm:rounded-[32px] p-6 pb-8 shadow-2xl animate-in slide-in-from-bottom duration-300 max-h-[85vh] overflow-y-auto">
                {/* Close Button */}
                <button
                    onClick={onClose}
                ...
                <button
                    onClick={onClose}
                    className="w-full mt-6 py-3.5 rounded-2xl font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors active:scale-[0.98]"
                >
                    Cerrar
                </button>
            </div>
